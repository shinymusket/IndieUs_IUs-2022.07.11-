...
public class EventController {
	...
	public String eventSelectByEventDate(@RequestParam String event_date, Model model) throws Exception {
		List<EventVO> eventList = service.eventSelectByEventDate(event_date);
		model.addAttribute("eventList", eventList);
