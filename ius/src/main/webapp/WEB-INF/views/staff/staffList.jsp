...
<body>
	...
	<table id="staffInfo" border="1" style="float : left; display : none;">
		...
		<tr>
			<td rowspan="4" id="staff_picture" width='94.4px' height='113.3px'>
		...
		<tr>
			...
			<td colspan="2">
				<input type="text" id="staff_rrn1" readonly="readonly">-<input type="text" id="staff_rrn2">
			</td>
		</tr>
		<tr>
			<th colspan="2">주소</th>
